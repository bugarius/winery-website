                ...
                <div className="menu_footer_wrap_inner">
                    <nav className="menu_footer_nav_area">
                        <ul id="menu_footer" className="menu_footer_nav">
                            ...
                            <li className="menu-item menu-item-677"><NavLink to={"/"}><span>Nasza filozofia</span></NavLink>
                            </li>
                            <li className="menu-item menu-item-147"><NavLink to={"/"}><span>Winnica</span></NavLink></li>
